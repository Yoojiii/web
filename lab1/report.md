...
1. Теория
1.1. HTML, CSS, JS
HTML (HyperText Markup Language) отвечает за структуру документа: заголовки, текст, изображения, списки, формы и другие элементы интерфейса.
CSS (Cascading Style Sheets) используется для стилизации HTML-элементов: задания цветов, шрифтов, отступов, расположения элементов на странице и адаптивной верстки.
JavaScript — язык программирования, который позволяет реализовывать логику на стороне клиента: обработку событий, работу с DOM-деревом, валидацию форм, динамическое изменение содержимого страницы.
Совместное использование HTML, CSS и JavaScript позволяет создавать интерактивные веб-интерфейсы, которые корректно отображаются в браузере и реагируют на действия пользователя.
